...
@section('content')
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            ...
            <p class="text-muted mb-0">Update your delicious momo details</p>
        </div>
        <div>
    ...
    <div class="row">
        ...
        <div class="col-lg-8">
            <div class="modern-card">
                ...
                <div class="card-body">
                    <form action="{{ route('admin.products.update', $product) }}" method="POST" class="form-modern"
                        id="productForm">
                        @csrf
                        @method('PUT')
                            ...
                            <div class="col-md-6 mb-4">
                                ...
                                <select class="form-select @error('category') is-invalid @enderror" id="category"
                                    ...
                                    <option value="steamed"
                                        ...
                                        Momo</option>
                                    <option value="fried"
                                        {{ old('category', $product->category) === 'fried' ? 'selected' : '' }}>🍤 Fried
                                        Momo</option>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-4">
                                ...
                                <select class="form-select @error('spice_level') is-invalid @enderror" id="spice_level"
                                    ...
                                    <option value="mild"
                                        {{ old('spice_level', $product->spice_level) === 'mild' ? 'selected' : '' }}>🌶️
                                        Mild</option>
                                    <option value="medium"
                                        {{ old('spice_level', $product->spice_level) === 'medium' ? 'selected' : '' }}>
                                        🌶️🌶️ Medium</option>
                                    <option value="spicy"
                                        {{ old('spice_level', $product->spice_level) === 'spicy' ? 'selected' : '' }}>
                                        🌶️🌶️🌶️ Spicy</option>
                        ...
                        <div class="mb-4">
                            ...
                            <textarea class="form-control @error('description') is-invalid @enderror" id="description" name="description"
                                rows="4" required placeholder="Describe the taste, ingredients, and what makes this momo special...">{{ old('description', $product->description) }}</textarea>
                            <div class="form-text">
                                <span id="descriptionCount">{{ strlen($product->description) }}</span>/500 characters
                            </div>
                            @error('description')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        ...
                        <div class="mb-4">
                            ...
                            <textarea class="form-control @error('ingredients') is-invalid @enderror" id="ingredients" name="ingredients"
                                rows="3" placeholder="e.g., Chicken, onions, garlic, ginger, cilantro, traditional spices">{{ old('ingredients', $product->ingredients) }}</textarea>
        ...
        <div class="col-lg-4">
            ...
            <div class="modern-card mb-4">
                <div class="card-header">
                    <h6 class="m-0 font-weight-bold">
                        <i class="fas fa-info-circle me-2"></i>Current Product
                    </h6>
                </div>
                <div class="card-body">
                    <div class="text-center">
                        ...
                        <div class="d-flex justify-content-between align-items-center">
                            <span class="h6 text-success mb-0">₹{{ number_format($product->price, 2) }}</span>
                            <span
